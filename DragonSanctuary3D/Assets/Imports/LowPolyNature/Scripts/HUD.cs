...
public class HUD : MonoBehaviour {
    ...
    {
        UnityEngine.Transform inventoryPanel = transform.Find("InventoryPanel");
        int index = -1;
        foreach (UnityEngine.Transform slot in inventoryPanel)
        {
            index++;

            // Border... Image
            UnityEngine.Transform imageTransform = slot.GetChild(0).GetChild(0);
            UnityEngine.Transform textTransform = slot.GetChild(0).GetChild(1);
