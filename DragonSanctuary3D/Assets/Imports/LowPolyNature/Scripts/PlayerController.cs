...
public class PlayerController : MonoBehaviour
{
    ...
    private void Inventory_ItemRemoved(object sender, InventoryEventArgs e)
    {
        ...
        UnityEngine.GameObject goItem = (item as MonoBehaviour).gameObject;
    ...
    {
        UnityEngine.GameObject currentItem = (item as MonoBehaviour).gameObject;
    ...
    public void DropCurrentItem()
    {
        ...
        UnityEngine.GameObject goItem = (mCurrentItem as MonoBehaviour).gameObject;
